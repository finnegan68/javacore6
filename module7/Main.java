...
public class Main {
    public static void main(String[] args) {
        ...
        users[1] = new User(124, "Petr","Petrovich", "Rome", 19236);
        ...
        ByPriceDecrease compareByPriceDecrease = new ByPriceDecrease();
        Collections.sort(orders, compareByPriceDecrease);
